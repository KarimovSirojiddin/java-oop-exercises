...
public class Test {
    public static void main(String[] args) {
        ...
        Student student1 = new Student(1,"Jahongir","Jahongirov",4,30000);
        Student student2 = new Student(2,"Xumoyin","Xumoyinov",3,40000);
        ...
        student2.pay(6000);
        System.out.println(student2.getName() + "remained fees: $" + student1.getRemainingFees());
